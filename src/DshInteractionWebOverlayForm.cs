...
internal sealed class DshInteractionWebOverlayForm : Form
{
    ...
    public DshInteractionWebOverlayForm(DshPendingInteraction interaction)
    {
        ...
        MaximumSize = new Size(720, Math.Max(400, Screen.PrimaryScreen?.WorkingArea.Height - 40 ?? 760));
        Width = interaction.Kind == DshInteractionKind.Approval ? 520 : 620;
        Height = interaction.Kind == DshInteractionKind.Approval ? 360 : Math.Min(720, 310 + interaction.Questions.Count * 165);
